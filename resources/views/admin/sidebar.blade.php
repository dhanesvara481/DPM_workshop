<aside id="sidebar"
  ...
  {{-- SCROLL AREA --}}
  <div class="flex-1 overflow-y-auto px-5 py-5 pb-24 md:pb-8"
       style="padding-bottom: max(6rem, env(safe-area-inset-bottom));">

    {{-- Profile Card — klik ke halaman profil --}}
    <a href="{{ route('tampilan_profil') }}"
      ...
      <div class="min-w-0 flex-1">
        <p class="text-sm font-medium truncate group-hover:text-white transition">{{ $username ?? 'User' }}</p>
    ...
    <nav class="mt-5 space-y-1">
      ...
      <a href="{{ route('tampilan_dashboard') }}" data-nav
        ...
        <span class="h-8 w-8 rounded-lg bg-white/5 border border-white/10 grid place-items-center shrink-0">
      ...
      <div class="mt-3">
        ...
        <a href="{{ route('mengelola_barang') }}" data-nav
          ...
          <span class="min-w-0 truncate">Kelola Barang</span>
        </a>
        ...
        <a href="{{ route('barang_masuk') }}" data-nav
          ...
          <span class="min-w-0 truncate">Barang Masuk</span>
        </a>
        ...
        <a href="{{ route('barang_keluar') }}" data-nav
          ...
          <span class="min-w-0 truncate">Barang Keluar</span>
        </a>
      </div>
      ...
      <div class="mt-3">
        ...
        <a href="{{ route('riwayat_perubahan_stok') }}" data-nav
          ...
          <span class="min-w-0 truncate">Riwayat Perubahan Stok</span>
        </a>
        ...
        <a href="{{ route('riwayat_transaksi') }}" data-nav
          ...
          <span class="min-w-0 truncate">Riwayat Transaksi</span>
        </a>
        ...
        <a href="{{ route('laporan_penjualan') }}" data-nav
          ...
          <span class="min-w-0 truncate">Laporan Penjualan</span>
        </a>
      </div>
      ...
      <div class="mt-3">
        ...
        <a href="{{ route('kelola_jadwal_kerja') }}" data-nav
          ...
          <span class="min-w-0 truncate">Kelola Jadwal Kerja</span>
        </a>
        ...
        <a href="{{ route('stok_opname.index') }}" data-nav
          ...
          <span class="min-w-0 truncate">Stok Opname</span>
        </a>
      </div>
