...
<div class="min-h-screen flex">
    ...
    <main id="main"
                            ...
                            <div class="field md:col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <select id="satuan" name="satuan" required
                                        ...
                                        @foreach (['pcs','unit','gram','set'] as $opt)
        ...
        <script>
            ...
            // Set preview awal (prefill dari database)
            updatePreviewHarga();
            ...
            // ===== Konfirmasi Keluar (Tombol Kembali) =====
            ...
            form?.addEventListener('submit', (e) => {
                // Konfirmasi
                const ok = confirm("Simpan perubahan data barang ini?");
                if (!ok) {
                    e.preventDefault();
                    return;
                }
                ...
                requiredIds.forEach(id => {
                    ...
                    if (!el || !String(el.value).trim()) {
                        ...
                        setTimeout(() => el?.classList.remove('border-red-300'), 2000);
                    } else {
                ...
                if (!isValid) {
                    e.preventDefault();
                    showToast('Gagal', 'Lengkapi semua field yang wajib diisi.', 'error');
                    return;
                }
                
                // Form akan submit ke backend (jangan preventDefault di sini)
            });

            // ===== Warning Sebelum Close Tab/Refresh =====
