...
<section class="relative p-4 sm:p-6">
  ...
  <div class="max-w-[920px] mx-auto w-full">
    ...
    <div class="rounded-2xl bg-white/85 backdrop-blur border border-slate-200 shadow-[0_18px_48px_rgba(2,6,23,0.08)] overflow-hidden">
      ...
      <form id="formTambahStaf" action="/tambah_staf" method="POST" class="p-5 sm:p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input id="username" name="username" value="{{ old('username') }}" maxlength="20" required
          ...
          <div>
            ...
            <input id="kontak" name="kontak" value="{{ old('kontak') }}" maxlength="12" required
...
<script>
  ...
  form?.addEventListener('submit', (e) => {
    ...
    showConfirmModal({
      title: "Simpan data staf?",
      message: "Akun staf baru akan dibuat dan bisa digunakan untuk login.",
      confirmText: "Ya, Simpan",
      cancelText: "Batal",
      note: "Pastikan username & email benar karena harus unik.",
      onConfirm: () => {
        form.dataset.confirmed = "1";
        snap0 = snapshot(); // reset dirty snapshot
        form.submit();
      }
    });
  });
