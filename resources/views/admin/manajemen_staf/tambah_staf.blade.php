...
<div class="min-h-screen flex">
  ...
  <main id="main" class="flex-1 min-w-0 relative overflow-hidden md:ml-[280px] transition-[margin] duration-300 ease-out">
      ...
      <div class="h-16 px-4 sm:px-6 flex items-center justify-between gap-3">
        <div class="flex items-center gap-3 min-w-0">
          ...
          <div class="min-w-0">
            ...
            <p class="text-xs text-slate-500">Buat akun staf agar bisa login (role otomatis <span class="font-semibold">staff</span>).</p>
          </div>
        </div>
    ...
    <section class="relative p-4 sm:p-6">
      <div class="max-w-[920px] mx-auto w-full">
        ...
        <div class="rounded-2xl bg-white border border-slate-200 shadow-[0_18px_48px_rgba(2,6,23,0.08)] overflow-hidden">
          <div class="p-5 sm:p-6 border-b border-slate-200">
            <div class="flex items-start justify-between gap-3">
              <div>
                ...
                <div class="text-xs text-slate-500 mt-1">Admin tidak dapat membuat admin baru. Role dikunci sebagai <span class="font-semibold">staff</span>.</div>
              </div>
          ...
          <form action="/tambah_staf" method="POST" class="p-5 sm:p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input name="username" value="{{ old('username') }}" maxlength="20" required
              ...
              <div>
                ...
                <input name="kontak" value="{{ old('kontak') }}" maxlength="12" required
              ...
              <div>
                ...
                <p class="mt-2 text-xs text-slate-500">Password akan di-hash di backend.</p>
              </div>
              ...
              <div class="sm:col-span-2">
                ...
                <textarea name="catatan" rows="3"
                          ...
                          class="mt-2 w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-slate-200">{{ old('catatan') }}</textarea>
    ...
    <script>
      ...
      // ===== CONFIRM NATIVE (kayak ubah_barang) =====
      const form = document.querySelector('form[action="/tambah_staf"]');
      ...
      // submit simpan (optional confirm)
      form?.addEventListener('submit', (e) => {
        const ok = confirm('Simpan data staf?');
        if (!ok) {
          e.preventDefault();
          return;
        }
