...
<aside id="sidebar"
  ...
  <div class="px-5 py-5">
    ...
    <div class="flex items-center gap-3 rounded-2xl bg-white/5 border border-white/10 px-4 py-3">
      <div class="h-10 w-10 rounded-full bg-white/10 border border-white/15 grid place-items-center overflow-hidden">
      ...
      <div class="min-w-0">
        ...
        <p class="text-[11px] text-white/60">{{ $role ?? 'Staf' }}</p>
      </div>
    </div>
    ...
    <nav class="mt-5 space-y-1">
      ...
      {{-- DASHBOARD --}}
      {{-- @php
        $dashActive = request()->is('tampilan_dashboard_staff*')
          || request()->is('staff/dashboard*');
      @endphp --}}

      <a href="/tampilan_dashboard_staff" data-nav
         class="nav-item  {{ $isActive(['tampilan_dashboard_staff']) ? 'is-active' : '' }} group mt-1 flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm
      ...
      <div class="mt-3">
        ...
        <a href="/stok_realtime_staff" data-nav
           class="nav-item  {{ $isActive(['stok_realtime_staff']) ? 'is-active' : '' }} group flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm
                  text-white/80 hover:bg-white/10 hover:text-white transition relative overflow-hidden">
          <span class="h-8 w-8 rounded-lg bg-white/5 border border-white/10 grid place-items-center">
            <svg class="h-[18px] w-[18px] text-white/70 group-hover:text-white transition" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div class="mt-3">
        ...
        @php
          $trxActive = request()->is('staff/transaksi*')
            || request()->is('staff/tampilan_transaksi*')
            || request()->is('staff/tampilan_invoice*'); // kalau kamu pakai invoice juga
        @endphp

        <a href="/tampilan_invoice_staff" data-nav
           class="nav-item {{ $isActive(['tampilan_invoice_staff']) ? 'is-active' : '' }} group flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm
                  text-white/80 hover:bg-white/10 hover:text-white transition relative overflow-hidden">
            <span class="h-8 w-8 rounded-lg bg-white/5 border border-white/10 grid place-items-center">
           <svg class="h-[18px] w-[18px] text-white/70 group-hover:text-white transition" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="/riwayat_transaksi_staff" data-nav
           class="nav-item  {{ $isActive(['riwayat_transaksi_staff']) ? 'is-active' : '' }} group mt-1 flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm
                  text-white/80 hover:bg-white/10 hover:text-white transition relative overflow-hidden">
          <span class="h-8 w-8 rounded-lg bg-white/5 border border-white/10 grid place-items-center">
            <svg class="h-[18px] w-[18px] text-white/70 group-hover:text-white transition" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div class="mt-3">
        ...
        <a href="/jadwal_kerja_staff" data-nav
           class="nav-item  {{ $isActive(['jadwal_kerja_staff']) ? 'is-active' : '' }} group flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm
                  text-white/80 hover:bg-white/10 hover:text-white transition relative overflow-hidden">
          <span class="h-8 w-8 rounded-lg bg-white/5 border border-white/10 grid place-items-center">
