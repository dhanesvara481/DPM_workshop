{{-- resources/views/staff/notifikasi/detail_notifikasi_staff.blade.php --}}
      ...
      <div class="rounded-2xl border border-slate-200 bg-white/85 backdrop-blur
        ...
        <div class="px-6 py-6">
          <div class="flex items-center gap-3 mb-4">
            <div class="h-10 w-10 rounded-xl bg-slate-100 border border-slate-200 grid place-items-center shrink-0">
              <svg class="h-5 w-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v4m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/>
              </svg>
            </div>
            <div>
              <div class="text-lg font-extrabold text-slate-900">Notifikasi tidak ditemukan</div>
      ...
      <div class="rounded-2xl border border-slate-200 bg-white/85 backdrop-blur
        ...
        <div class="px-6 py-5">
          <div class="flex items-center gap-3">
            ...
            <div>
              <div class="text-xl font-extrabold tracking-tight text-slate-900">Detail Notifikasi</div>
              <p class="text-xs text-slate-500 mt-0.5">Informasi lengkap pemberitahuan</p>
            </div>
          </div>
