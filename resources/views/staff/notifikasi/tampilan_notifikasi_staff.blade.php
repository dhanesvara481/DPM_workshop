{{-- resources/views/staff/notifikasi/tampilan_notifikasi_staff.blade.php --}}
...
<section class="relative p-4 sm:p-6">
  ...
  <div class="max-w-[780px] mx-auto w-full">
    <div class="rounded-2xl border border-slate-200 bg-white/85 backdrop-blur
      ...
      <div class="px-6 py-5">
        <div class="flex items-center gap-3">
          <div class="h-10 w-10 rounded-xl bg-slate-900 grid place-items-center shrink-0">
          ...
          <div>
            <div class="text-xl font-extrabold tracking-tight text-slate-900">Notifikasi Saya</div>
            <p class="text-xs text-slate-500 mt-0.5">Pemberitahuan otomatis dari sistem</p>
          </div>
        </div>
        <div class="mt-4 h-1 bg-slate-900 rounded-full"></div>
      </div>
      ...
      <div class="px-6 pb-6">
        @if ($items->isEmpty())
          <div class="rounded-2xl border border-dashed border-slate-200 bg-slate-50 py-12 text-center">
            <div class="mx-auto h-14 w-14 rounded-full bg-slate-100 border border-slate-200 grid place-items-center mb-4">
              <svg class="h-7 w-7 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.4-1.4A2 2 0 0118 14.2V11a6 6 0 10-12 0v3.2c0 .5-.2 1-.6 1.4L4 17h5"/>
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 17a3 3 0 006 0"/>
              </svg>
            </div>
            <div class="font-semibold text-slate-800">Tidak ada notifikasi</div>
            <div class="mt-1 text-sm text-slate-500">Semua notifikasi akan muncul di sini secara otomatis.</div>
          </div>
        @else
